...
f=open('D:\paper_data\\01_CCK\\05_chow\chow.txt','a')

path=r'D:\paper_data\01_CCK\02_processed_data\CSAD_Whole.csv'
df_id=pd.read_csv('D:\paper_data\\00_indices\\02_processed_data\SWI_indices_Whole.csv',encoding='gb18030')
...
for i in range(2,cols):
    ...
    for i in [0.01,0.05,0.1]:
        res=chow_test(X_series=df_2 ,y_series= df['y'],last_index=746,first_index=747,significance=i)
